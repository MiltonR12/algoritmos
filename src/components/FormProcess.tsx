...
function FormProcess() {
  ...
  const { addProcess, process, updateTableProcess, orderPriority } =
    useProcessState();
      ...
      <dialog ref={dialogRef} className="p-5 rounded-lg bg-zinc-900">
        <Formik
          ...
          onSubmit={(data) => {
            ...
            if (orderPriority) {
              const aux = orderByPriorityProcess([...process, newProcess]);
              const order = updateProcessTable(aux);
              updateTableProcess(order);
            } else {
            ...
            <form onSubmit={handleSubmit}>
              <div className="flex flex-col gap-3">
                ...
                <InputCustom
                  ...
                  type="number"
                />
                <InputCustom title="Prioridad" name="priority" type="number" />
